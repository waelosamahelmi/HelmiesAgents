...
class GatewayRouter:
    ...
    def _inject_hired_agent_persona(self, *, tenant_id: str, event: GatewayEvent, raw_text: str) -> tuple[str, dict[str, Any] | None]:
        ...
        persona_block = (
            ...
            f"Model provider preference: {hired.get('model_provider') or '-'}\n"
            f"Model name preference: {hired.get('model_name') or '-'}\n"
            f"Model base URL preference: {hired.get('model_base_url') or '-'}\n"
